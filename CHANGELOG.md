...
## [0.1.2.post1] - 2025-12-23

### Fixed
- **Critical**: Added `click>=8.0` as required dependency (CLI was broken without it)
- Improved CLI fallback handling for missing dependencies
